...
const markNotificationAsRead = useMarkNotificationAsRead(notification);
  ...
  const { icon, message, link, description } = useNotificationCardLogic(notification);
