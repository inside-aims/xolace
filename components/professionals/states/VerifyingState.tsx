...
export const VerifyingState = ({setState}: VerifyingStateProps ) => {
 const [otpUuid, setOtpUuid] = useState<string>('');
  ...
  const onFormSubmit = (data: OTPForm) => {
    const payload: {otp_uuid: string, otp_code: string} = {
      otp_uuid: otpUuid,
      otp_code: data.otp_code
    }
    console.log("data", payload);
    setState("finished"); //after success
    reset();
  };
