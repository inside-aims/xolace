...
export function Menu({
  ...
  return (
    <motion.div
      ...
      className="fixed top-[50%] left-[50%] z-30 flex w-[70vw] flex-col items-center justify-center gap-5 rounded-xl bg-gray-900/90 py-12 backdrop-blur-md dark:bg-gray-200"
    >
      <div className="dark:text-dark-3 flex flex-col items-center justify-center gap-5 text-white">
