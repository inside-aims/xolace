...
export default function HealthTips() {
  return (
    <div className="flex flex-col w-full md:px-4 gap-4">
      <div className="hidden md:flex flex-col gap-2  p-2 md:p-4 items-start border shadow-lg rounded-2xl">
        ...
        <div>
          Practical tips and trusted advice to help you thrive—mind and body.
        </div>
      </div>

      <div className="flex flex-col gap-2 md:gap-4 py-2 md:py-4 items-start border shadow-lg rounded-2xl">
