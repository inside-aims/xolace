    ...
    <div className="flex items-center justify-between px-3">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-40 bg-gray-900 border-gray-700">
          ...
          >
            <DropdownMenuRadioItem value="recent" className="text-gray-300 focus:bg-gray-800 focus:text-white">
              Most Recent
            </DropdownMenuRadioItem>
            <DropdownMenuRadioItem value="most-liked" className="text-gray-300 focus:bg-gray-800 focus:text-white">
              Most Liked
            </DropdownMenuRadioItem>
            <DropdownMenuRadioItem value="most-viewed" className="text-gray-300 focus:bg-gray-800 focus:text-white">
              Most Viewed
            </DropdownMenuRadioItem>
          </DropdownMenuRadioGroup>
        </DropdownMenuContent>
